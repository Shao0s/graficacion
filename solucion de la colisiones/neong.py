...
paredes = [
    pygame.Rect(-5, 0, 10, 500),
    pygame.Rect(895, 0, 10, 500)
]
...
while True:
    ...
    for pared in paredes:
        if jugador.colliderect(pared):
            if vel_x > 0:  # choca moviéndose a la derecha
                jugador.right = pared.left
            elif vel_x < 0:  # choca moviéndose a la izquierda
                jugador.left = pared.right
